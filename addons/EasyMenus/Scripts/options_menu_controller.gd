...
const save_manager = preload("res://Components/save_manager/save_manager.gd")
...
@onready var mouse_sense_range := $%MouseSenseSpinBox
...
func save_options():
	...
	config.set_value(OptionsConstants.section_name, OptionsConstants.mouse_sensitivity_key_name, mouse_sense_range.value)
...
func load_options():
	...
	var music_volume = config.get_value(OptionsConstants.section_name, OptionsConstants.music_volume_key_name, 0.5)
	var mouse_sensitivity = config.get_value(OptionsConstants.section_name, OptionsConstants.mouse_sensitivity_key_name, 1.0)
	...
	mouse_sense_range.value = mouse_sensitivity
